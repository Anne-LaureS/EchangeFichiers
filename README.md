...
Les améliorations permettent l’envoi de fichiers du client vers le serveur et l’implémentation de commandes (CMD).  
Un script complémentaire permet de visualiser les statistiques d’utilisation du disque.
